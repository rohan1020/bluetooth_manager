...
public class MainActivity extends Activity {
    ...
    private String MBP_MAC_ADDRESS = "B8:5E:7B:0C:0A:6E";
    ...
    public void getBTDevice() throws IOException {
        remoteDevice =  myBluetoothAdapter.getRemoteDevice(MBP_MAC_ADDRESS);
...
//        text.setText("Status: Disconnected");
        ...
        Toast.makeText(getApplicationContext(),"Connecting Device",
                Toast.LENGTH_LONG).show();
    }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    if(bytes > 10)
                        Log.d("BTRecieve", new String(buffer,0,bytes));
                        text.setText(new String(buffer,0,bytes));
